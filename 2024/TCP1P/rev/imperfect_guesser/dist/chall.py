...
out1 = np.dot(model[0].weight.data.numpy() , floatify(flag).numpy().squeeze() ) + model[0].bias.data.numpy()
out2 = np.dot(model[1].weight.data.numpy() , out1 ) + model[1].bias.data.numpy()
out3 = np.dot(model[2].weight.data.numpy() , out2 ) + model[2].bias.data.numpy()

print( floatify(flag).numpy().squeeze().tolist() )
print(out1.tolist())
print(out2.tolist())
print(out3.tolist())
